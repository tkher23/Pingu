...
const SubscriptionsOnboardingPanel = () => {
  ...
  return (
    ...
    >
      <Text size="md" mb="md">
        Here you can view your current plan, see when it ends, and upgrade or change your subscription. All your plan and credit info is managed here. Simple emails use 1 credit and Advanced emails uses 2 credits per profile.
      </Text>
